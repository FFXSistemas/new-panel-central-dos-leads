...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Fila de Vendas Liberadas</h2>
            <ol class="breadcrumb">
                <li>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Vendas Liberadas na Auditoria :</h5>
                            ...
                            @foreach($sales as $sale)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!empty($sale->pegasusSale))
                                                   {{ ($sale->pegasusSale->Status == 'Não Venda') ? 'btn-danger':'btn-primary'}}
                                                   @endif">
                                               <b>{{ (!empty($sale->pegasusSale->Motivo)) ? $sale->pegasusSale->Motivo:"Não disponivel" }}</b></button>
                                    </td>
                                    <td>
